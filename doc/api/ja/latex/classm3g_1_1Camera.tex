...
\index{m3g::Camera@{m3g::Camera}!duplicate@{duplicate}}
\index{duplicate@{duplicate}!m3g::Camera@{m3g::Camera}}
\subsubsection[{duplicate}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Camera} $\ast$ duplicate () const\hspace{0.3cm}{\tt  \mbox{[}virtual\mbox{]}}}}
